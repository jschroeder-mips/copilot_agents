...
description: Expert technical guidance, architectural decisions, code reviews, and mentoring across Cloud platforms (AWS, GCP, Azure), Python, TypeScript, and Godot Engine development
---
